    ...
    <>
      ...
      <div className="min-h-screen bg-teal-50 px-6 py-12">
        ...
        <section className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          {[
            { title: "Citas Médicas", desc: "Agenda y gestiona tus citas", path: "/generate-appointment", icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },

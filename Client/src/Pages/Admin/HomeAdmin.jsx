...
const quickLinks = [
    ...
    { name: 'Administrar Productos', url: '/admin/products/manageProducts', icon: 'M5 3a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V5a2 2 0 00-2-2H5zm2 4h10v2H7V7zm0 4h10v2H7v-2zm0 4h10v2H7v-2z' }, // Icono para productos
];
